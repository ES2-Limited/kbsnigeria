    ...
    <div className="bg-surface-white">
      ...
      <section className="overflow-hidden bg-hero-gradient text-white">
        <div className="mx-auto max-w-7xl px-6 pb-20 pt-16 sm:px-8 sm:pb-24 lg:px-10 lg:pt-24">
          <motion.div className="max-w-3xl space-y-5" {...fadeUpMotion(prefersReducedMotion)}>
            <p className="font-calligraphy text-xl italic text-kbs-lavender">About KBS</p>
      ...
      <motion.section className="py-20 sm:py-24" {...fadeUpMotion(prefersReducedMotion)}>
        <div className="mx-auto grid max-w-7xl gap-12 px-6 sm:px-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center lg:px-10">
          <IllustrationPlaceholder className="min-h-[320px] bg-surface-grey" label="Founding story illustration placeholder" />
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <Card className="space-y-4">
              <h2 className="font-display text-3xl text-kbs-navy">Our Mission</h2>
              <p className="font-body text-base leading-8 text-text-medium">
            ...
            <Card className="space-y-4">
              <h2 className="font-display text-3xl text-kbs-navy">Our Vision</h2>
              <p className="font-body text-base leading-8 text-text-medium">
      ...
      <motion.section className="py-20 sm:py-24" {...fadeUpMotion(prefersReducedMotion)}>
        <div className="mx-auto grid max-w-7xl gap-10 px-6 sm:px-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:px-10">
          <IllustrationPlaceholder className="min-h-[360px] bg-surface-grey" label="Principal photo placeholder" />
          <div className="space-y-6">
            <SectionHeader
              align="left"
            ...
            />
            <blockquote className="font-calligraphy text-2xl italic leading-10 text-kbs-purple sm:text-[1.75rem]">
            ...
            {staff.map((member) => (
              <Card className="space-y-4 p-4 sm:p-6" key={member.name}>
                ...
                <div className="space-y-1">
                  <h3 className="font-body text-lg font-semibold text-text-dark">{member.name}</h3>
                  <p className="font-body text-sm text-text-medium">{member.role}</p>
                </div>
              </Card>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {affiliations.map((item) => (
              <div
                className="flex min-h-24 items-center justify-center rounded-2xl border border-surface-grey bg-white px-4 text-center font-body text-sm font-semibold text-kbs-navy shadow-sm"
                key={item}
              >
                {item}
              </div>
